...
const register = async (req, res) => {
    ...
    if (existingUser !== null) {
        return res.send("User already registered Plz try to login")
    }
...
const login = async (req, res) => {
    ...
    if (isUser == null) {
        return res.send("User is not registered Register 1st")
    }
    ...
    return res.send("Password does not match  plz enter the correct password")
}
